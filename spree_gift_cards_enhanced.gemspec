Gem::Specification.new do |s|
  ...
  s.name        = 'spree_gift_cards_enhanced'
  s.version     = '1.0.0.beta'
  s.summary     = 'Spree Gift Card Enhanced'
  s.description = 'Spree Gift Card Extension'

  s.authors     = ['Jonathan Tapia']
  s.email       = ['jonathan.tapia@crowdint.com']
  s.homepage    = 'http://github.com/jtapia/spree_gift_cards_enhanced'
  ...
  s.add_dependency 'spree_gift_card',   '~> 2.2.0,beta'
